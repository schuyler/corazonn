...
class AudioEngine:
    ...
    def __init__(self, port=8001, control_port=8004, sounds_dir="sounds", enable_panning=False, enable_intensity_scaling=False, config_path="amor/config/samples.yaml"):
